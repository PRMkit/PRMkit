...
findridge = partial(PRMcwt.findridge0, wave_scales, wave_sqrt, False)
findridge2 = partial(PRMcwt.findridge0, wave_scales, wave_sqrt, True)
...
for sta_ in range(0, len(mzML_files), nfile):
    eic_dict_all = list(map(PRMeic.print_eic, mzML_files[sta_ : sta_ + nfile]))
